...
class UpdateEventDialog extends StatefulWidget {
  const UpdateEventDialog({super.key, required this.event});
  final Event event;
...
class _UpdateEventDialogState extends State<UpdateEventDialog> {
  ...
  void onAddEventPressed() {
    ...
    BlocProvider.of<EventCubit>(context).editEvent(
      ...
      eventName: BlocProvider.of<EventCubit>(context).editTitleController.text,
      eventDescription:
          BlocProvider.of<EventCubit>(context).editNoteController.text,
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: const Center(child: Text('Edit Event')),
      content: Container(
        ...
        child: SingleChildScrollView(
          ...
          children: [
            ...
            TextFormField(
              controller:
                  BlocProvider.of<EventCubit>(context).editNoteController,
              decoration: InputDecoration(
